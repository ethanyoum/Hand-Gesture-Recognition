...
predictions_CNN, all_proba_CNN, all_classes_CNN, test_loss_CNN, test_acc_CNN = test_model(model,test_loader, size=dset_sizes['test'], criterion=criterion, 
